                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-10">
                                                <input class="form-control" type="text" value="${{ $product->price }}.00" id="html5-email-input" readonly />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-10">
                                                <input class="form-control" type="email" value="" id="html5-tel-input" />
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-10">
                                                <textarea class="form-control" id="html5-password-input" /></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-12 col-lg-12">
                                    <!-- <a href="javascript:void(0)" class="btn btn-primary"><i class="tf-icons bx bx-cart-alt me-1"></i>Buy Now</a> -->
